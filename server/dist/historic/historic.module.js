...
let HistoricModule = exports.HistoricModule = class HistoricModule {
};
exports.HistoricModule = HistoricModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule],
        controllers: [historic_controller_1.HistoricController],
        providers: [historic_service_1.HistoricService],
    })
], HistoricModule);
